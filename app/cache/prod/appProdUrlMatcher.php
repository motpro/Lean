...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // lean_login_homepage
        if (0 === strpos($pathinfo, '/get_current_user') && preg_match('#^/get_current_user/(?P<type>username|email|id)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'lean_login_homepage')), array (  '_controller' => 'Lean\\LoginBundle\\Controller\\DefaultController::indexAction',));
        }
        ...
        // rest_search_contact
        if ($pathinfo === '/search_contact') {
            return array (  '_controller' => 'Lean\\RestBundle\\Controller\\ContactController::searchAction',  '_route' => 'rest_search_contact',);
        }
        ...
        if (0 === strpos($pathinfo, '/ad')) {
            ...
            // adminlist_index
            if ($pathinfo === '/adminlist_index') {
                return array (  '_controller' => 'Lean\\AdminBundle\\Controller\\AdminlistController::indexAction',  '_route' => 'adminlist_index',);
            }
